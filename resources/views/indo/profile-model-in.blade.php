...
@section('title', 'Profile | Vind Website')
							...
							<div class="panel-body">
								...
								<table class="table table-borderless">
									<tbody>
										...
										<tr>
											<td>Jenis kelamin</td>
											<td style="color:green">perempuan</td>
										</tr>
										<tr>
											<td>Tinggi badan</td>
								...
								<button class="btn btn-success" type="button">tawarkan menjadi model anda</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-auto">
				<div class="file btn button-lg" style="width:1110px">
					<p style="float:left">Unggah foto portofolio : &nbsp
