...
@section('title', 'Edit Acara | Vind Website')

<div class="header">
	<p>Language : &nbsp  
	<a href="/edit-event-en">English</a>&nbsp &nbsp;
	<a href="/edit-event-in">Bahasa</a>&nbsp &nbsp; </p>
</div>
...
@section('content')
	...
	<h1 style="color:#8397b3; text-align:center">Edit Acara</h1>
	<div class="container">
		<div class="shadow p-4 mb-4 bg-white">
			<form action="/action_page.php">
				<div class="form-group">
					<label for="subject">Judul Acara:</label>
					<input type="text" class="form-control" id="subject" placeholder="Judul Acara" name="subject">
				</div>
				<div class="form-group">
